...
// dados da api
    ...
    $lolprofilename = $_SESSION['profilelol_name'];
    $lolprofilelevel = $_SESSION['profilelol_level'];
    $idlol = $_SESSION['profilelol_id'];

    // cadastra os dados na tabela tb_perfillol
        $sql = "INSERT INTO tb_perfillol values (null,'$nick','$objetivo','$estado','$camp1','$camp2','$camp3','$camp4','$camp5','$elo','$lane1','$lane2','$usuario',null,'$idlol',0,'$lolprofilename','$lolprofilelevel',$elo2)";
